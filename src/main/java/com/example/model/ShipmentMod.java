...
public class ShipmentMod implements Serializable {
	...
	public ShipmentMod(int shipmentId, long invoiceNumber, int customerId, String deliverAddress, String mobileNumber,
			String zipCode) {
		super();
