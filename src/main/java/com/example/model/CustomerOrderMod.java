...
public class CustomerOrderMod implements Serializable{
	...
	public CustomerOrderMod() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public CustomerOrderMod(long orderId, int customerId, long invoiceNumber, int productCode, String orderDateTime,
	...
	///view according to customerId
	public List<CustomerOrderMod> getAllCustomerOrders(int CustomerId){
	List<CustomerOrderMod> customerordersList=new ArrayList<CustomerOrderMod>();
	...
	try {
	    ...
	    while(rs.next()) {
	    	CustomerOrderMod customerorders= new CustomerOrderMod();
	...
	///viewing details in The Admin
		public List<CustomerOrderMod> getAllOrders(){
		List<CustomerOrderMod> customerordersList=new ArrayList<CustomerOrderMod>();
		...
		try {
		    ...
		    String qry="select orderId,customerId,invoiceNumber,productCode,orderDateTime,cost,discountAmount,quantity,gstAmount,billAmount,orderStatus from customerorders order by orderDateTime";
		    PreparedStatement pst = conn.prepareStatement(qry);
