...
public class InvoicesMod implements Serializable{
	...
	public InvoicesMod(long invoiceNumber, long orderId, int invoiceAmount, String invoiceDate, String invoiceType,
	...
	//view
	public List<InvoicesMod> getAllInvoices(){
		List<InvoicesMod> invoicesList=new ArrayList<InvoicesMod>();
		...
		try {
		    ...
		    while(rs.next()) {
		    	InvoicesMod invoices= new InvoicesMod();
