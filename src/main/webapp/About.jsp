...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-white" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item text-dark" href="./Customer/CustomerLogin.jsp">Customer</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <span class="text-dark">Our Story</span>
    <h2 class="display-5 fw-bold">About E-Commerce</h2>
    <p class="lead">E-commerce, short for electronic commerce, is the buying and selling of goods and services over the internet. It has revolutionized the way businesses operate and how consumers shop. It provides convenience, accessibility, and a wide range of options to consumers, while enabling businesses to reach a global audience and operate with lower overhead costs compared to traditional brick-and-mortar stores.</p>
</div>
