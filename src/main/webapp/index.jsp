...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link mx-2 active text-white" aria-current="page" href="#">Home</a></li>
    ...
    <div id="hero" style="background: url('./images/ecom.webp') no-repeat; background-size: cover; background-position: top center">
        <div>
            <h1 class="display-3">Welcome To E-Commerce</h1>
            <p>Want To Shop Our Products</p>
