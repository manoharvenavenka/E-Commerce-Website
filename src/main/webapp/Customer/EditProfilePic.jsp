...
<form action="/EcommersProject/ProfilePicUpdateServlet" method="post" enctype="multipart/form-data">

        <div class="container mt-3 card " style="background-color:#EAA95C;">
            <center>
